...
- [Governance Model](governance-model.md): Constitutional model and included [governance policy](https://github.com/BTCDecoded/governance/blob/main/GOVERNANCE.md)

...
blvm-spec-lock proofs verify mathematical specifications:
...
- blvm-spec-lock proofs (formal verification)
...
- [Formal Verification](formal-verification.md) - blvm-spec-lock verification details

...
The implementation is validated against the [Orange Paper](../reference/orange-paper.md); optimization passes optimize the implementation code (not the spec). Meaning is defined by the Orange Paper; see [compiler-like architecture](../reference/glossary.md#compiler-like-architecture). Production and Rayon feature flags: [consensus features](https://github.com/BTCDecoded/blvm-consensus/blob/main/docs/FEATURES.md).

...
More examples and topic details: [ZMQ notifications](https://github.com/BTCDecoded/blvm-node/blob/main/docs/ZMQ_NOTIFICATIONS.md) (operator reference; configuration lives in **`blvm-zmq`**, not `[zmq]` on the node).

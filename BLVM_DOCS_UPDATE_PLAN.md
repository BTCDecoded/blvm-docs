...
| **P1-6** | Book [`formal-verification.md`](src/consensus/formal-verification.md) states proof-to-code extraction is out of scope but does **not** yet describe the **implementation trust boundary**, **byte-layer golden vectors**, **proof portfolio**, or **external btc-verified Lean oracle** (dual-oracle model). Workspace plan: [`BTC_VERIFIED_LESSONS_PLAN.md`](../docs/BTC_VERIFIED_LESSONS_PLAN.md) **W11**, gated on Phases 1-4. | After W0-W10 land: reframe verification chapter + FAQ/glossary/design-philosophy: hand-written Rust vs proof extraction; layered enforcement (tests, Z3, differential, external Lean); link `PROOF_PORTFOLIO.md`; explicit non-goals (no Lean in Commons CI, no Kani/Creusot). **Do not** ship P1-6 prose before implementation artifacts exist. | [`consensus/formal-verification.md`](src/consensus/formal-verification.md), [`appendices/faq.md`](src/appendices/faq.md), [`reference/glossary.md`](src/reference/glossary.md), [`architecture/design-philosophy.md`](src/architecture/design-philosophy.md); optional new [`consensus/byte-layer-verification.md`](src/consensus/byte-layer-verification.md) |
...
2. **P1-1, P1-2** 
3. **P1-3, P1-4, P1-5** 
4. **P1-6**: after [`BTC_VERIFIED_LESSONS_PLAN.md`](../docs/BTC_VERIFIED_LESSONS_PLAN.md) Phases 1-4 (W11) 
5. **P2** 
6. **§6 submodule**: maintainer sign-off
...
| Tier | IDs | Rule |
|------|-----|------|
| **Timeless book** | P0-1, P0-4, P1-1, P1-2, P1-4, P1-6, P2-1, P2-4 | Architecture, BIP reference, dependency **principles**, verification **honesty**, qualitative claims: no sprint language. |
